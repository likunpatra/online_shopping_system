...
const Product = () => {
    ...
    return productData ? (
        <div className="p-10 transistion-opacity ease-in duration-500 opacity-100 bg-white mb-10 shadow-[-10px_10px_20px_rgba(0,0,0,0.678)]">
            {/* ------------product data----------- */}
            <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
                ...
                <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-500 flex flex-col gap-1">
                        ...
                        <p>Easy retur and exchange policy within 7 days.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-20">
                ...
                <div className="flex flex-col gap-4 border border-gray-400 px-6 py-6 text-sm text-gray-500">
                    ...
                    <p>E-commerce websites have gained immense
                        ...
                        the global reach they offer. E-commerce websites
                        typically display products or services along with
                        detailed descriptions, images, prices, and any available
                        variations (e.g., sizes, colors). Each product usually
